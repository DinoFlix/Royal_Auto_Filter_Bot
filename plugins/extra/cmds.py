...
async def admin_cmds(client, message):
    buttons = [
        ...
        [KeyboardButton("⚡ powered by @Codeflix_Bots")]
    ]
...
async def set_commands(client, message):
    commands = [
        ...
        BotCommand("lucy", " ᴀɪ ʙʏ ɢᴏᴏɢʟᴇ"),
        BotCommand("blackbox", "ᴛᴇxᴛ ᴡɪᴛʜ ʀᴇᴘʟʏ ᴛᴏ ᴛʜᴇ ᴘʜᴏᴛᴏ ᴏʀ ᴊᴜsᴛ ᴛᴇxᴛ"),
        BotCommand("myinfo", "ᴜsᴇʀ ɪɴғᴏ"),
        BotCommand("tgm", "to get telegraph image link"),
        ...
        BotCommand("ginfo", "Check Group Details"),
        BotCommand("setlog", " ᴛᴏ ᴄᴏɴɴᴇᴄᴛ ʏᴏᴜʀ ʟᴏɢ ᴄʜᴀɴɴᴇʟ"),
        BotCommand("shortlink", "ᴀᴅᴅ ᴠᴇʀɪғʏ 𝟷 sʜᴏʀᴛɴᴇʀ"),
        BotCommand("verify2", "ᴀᴅᴅ ᴠᴇʀɪғʏ 2 sʜᴏʀᴛɴᴇʀ"),
        BotCommand("verify3", "ᴀᴅᴅ ᴠᴇʀɪғʏ 3 sʜᴏʀᴛɴᴇʀ"),
        BotCommand("time2", "ᴛᴏ ᴄʜᴀɴɢᴇ ᴠᴇʀɪғʏ ᴛɪᴍᴇ"),
        BotCommand("time3", "ᴛᴏ ᴄʜᴀɴɢᴇ ᴠᴇʀɪғʏ ᴛɪᴍᴇ"),
        BotCommand("verifyoff", "for verify off [owner only]"),
        BotCommand("verifyon", "for verify off [owner only]"),
        BotCommand("set_caption", "set coustom file caption"),
        BotCommand("set_tutorial", "set verification tutorial"),
