...
import asyncio
from pyrogram import idle
from web.bot import CodeflixBot
from web.util.keepalive import ping_server
...
async def Codeflix_start():
    ...
    for name in files:
        with open(name) as a:
            ...
            print("The Lucy Imported => " + plugin_name)
    if ON_HEROKU:
...
if __name__ == '__main__':
    try:
        loop.run_until_complete(Codeflix_start())
