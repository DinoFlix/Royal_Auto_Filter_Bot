...
ғɪʀsᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴊᴏɪɴ ɴᴏᴡ" ʙᴜᴛᴛᴏɴ ᴀғᴛᴇʀ ᴛʜᴀᴛ, ᴛʀʏ ᴀᴄᴄᴇssɪɴɢ ᴛʜᴀᴛ ᴍᴏᴠɪᴇ ᴛʜᴇɴ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴛʀʏ ᴀɢᴀɪɴ" ʙᴜᴛᴛᴏɴ.</b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/MoviesFlixOP">Ragnar</a></b></blockquote>"""
    

    ABOUT_TXT = """
<blockquote><b>❍ ᴍʏ ɴᴀᴍᴇ : <a href="https://t.me/MoviesNationhubbot">Ana Bot</a>
❍ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/AnimeHolic_Nerd">Ragnar</a>
❍ ʟɪʙʀᴀʀʏ : <a href="https://pyrogram.org/">ᴘʏʀᴏɢʀᴀᴍ</a>
❍ ʟᴀɴɢᴜᴀɢᴇ : <a href="https://www.python.org/">ᴘʏᴛʜᴏɴ</a>
❍ ᴅᴀᴛᴀʙᴀꜱᴇ : <a href="https://www.mongodb.com/">ᴍᴏɴɢᴏ ᴅʙ</a>
❍ ʜᴏꜱᴛᴇᴅ ᴏɴ : <a href="https://t.me/RagnarServers">ᴠᴘs</a>
...
ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ɪɴ ˹ʟᴜᴄʏ˼ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ɢɪᴠᴇ ғᴇᴇᴅʙᴀᴄᴋ ᴀʙᴏᴜᴛ ᴛʜᴇ ʙᴏᴛ˼, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴀᴛ <a href='https://t.me/RagnarChats'>sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ</a>.</b>"""
...
BOT WORKING PROPERLY BY CODEFLIX 🔥"""
...
<blockquote>» ᴛᴏᴛᴀʟ ᴜsᴇʀs - <code>{}</code>
...
<blockquote>‣ sᴛᴏʀʏ : {plot}</blockquote>
...
<blockquote><i>ᴘʟᴇᴀsᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪs ꜰɪʟᴇs ᴛᴏ ᴛʜᴇ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴄʟᴏsᴇ ᴛʜɪs ᴍᴇssᴀɢᴇ</i></blockquote>"""
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    NO_RESULT_TXT = """😴 ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɴᴏᴛ ғᴏᴜɴᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ.**\n\n» ᴍᴀʏʙᴇ ᴛᴜɴᴇ ɢᴀʟᴀᴛ ʟɪᴋʜᴀ ʜᴏ, ᴩᴀᴅʜᴀɪ - ʟɪᴋʜᴀɪ ᴛᴏʜ ᴋᴀʀᴛᴀ ɴᴀʜɪ ᴛᴜ !"""
    
    I_CUDNT = """<blockquote><b>ꜱᴏʀʀʏ ɴᴏ ꜰɪʟᴇꜱ ᴡᴇʀᴇ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ

ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ.

ʀᴇᴀᴅ ɪɴ𝗌ᴛʀᴜᴄᴛɪᴏɴ𝗌 ғᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇ𝗌ᴜʟᴛ𝗌 </b></blockquote>"""
    
    I_CUD_NT = """<blockquote><b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.

ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ. 

ʀᴇᴀᴅ ɪɴꜱᴛʀᴜᴄᴛɪᴏɴ ғᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇ𝗌ᴜʟᴛ𝗌 </b></blockquote>"""
    
    CUDNT_FND = """<blockquote><b> ꜱᴘᴇʟʟɪɴɢ ᴍɪꜱᴛᴀᴋᴇ ʙʀᴏ ⁉️
ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ, ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ </b></blockquote>"""
...
ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ɴᴇxᴛ <code>{}</code></b>"""
    ...
    SECOND_VERIFICATION_TEXT = """<b>ʜᴇʏ ʙʀᴏ,\n\n ‼️ ʏᴏᴜ'ʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ ‼️\n\n ›› ᴘʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ.\n\n››ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- 2/3\n\n ›› ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ғɪʟᴇs ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ sᴇʀᴠɪᴄᴇs.</b>"""
...
ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ꜰᴏʀ ɴᴇxᴛ <code>{}</code></b>"""
    ...
    THIRDT_VERIFICATION_TEXT = """<b>ʜᴇʏ ʙʀᴏ,\n\n ‼️ ʏᴏᴜ'ʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ ‼️\n\n ›› ᴘʟᴇᴀsᴇ ᴠᴇʀɪғʏ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ.\n\n››ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:- 3/3\n\n ›› ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ғɪʟᴇs ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ sᴇʀᴠɪᴄᴇs.</b>"""
...
#verified_{}_completed"""
    ...
    MOVIES_UPDATE_TXT = """<b>ɴᴇᴡ ᴍᴏᴠɪᴇ ᴀᴅᴅᴇᴅ
...
"""
    PAYHELP_TXT = """
 <blockquote><b>To Activate Your Subscription Follow This Steps

1. Scan The QR Code Or Copy The UPI ID

2. Make Payment
 
3. Click On Confirm Button In Here

4. Send Your UTR Or Transaction ID Number To The Bot To Verify Your Payment 

5. After Verification Complete You Will Get Premium Instently.

Note :- Don't Pay Any Lower Or Higher Ammount. Only Pay Exexct Ammount That Are Mentioned According To Plan. Payment With Incorrect Ammount Will Rejected And Not Premium Will Be Activated .</b></blockquote>

<b>UPI Id : </b> <code>Code Here</code>
"""
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>dm - @AnimeHolic_Nerd</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/AnimeHolic_Nerd'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
➩ /leave - Leave the specified group
›› /send  - Use this command as a reply to any message
➩ /ban - Ban user 
›› /unban - Unban user
...
• /setlog - ᴛᴏ ᴄᴏɴɴᴇᴄᴛ ʏᴏᴜʀ ʟᴏɢ ᴄʜᴀɴɴᴇʟ
• /shortlink ᴀᴅᴅ ᴠᴇʀɪғʏ 𝟷 sʜᴏʀᴛɴᴇʀ
• /verify2 ᴀᴅᴅ ᴠᴇʀɪғʏ 2 sʜᴏʀᴛɴᴇʀ
• /verify3 ᴀᴅᴅ ᴠᴇʀɪғʏ 3 sʜᴏʀᴛɴᴇʀ
• /time2 ᴛᴏ ᴄʜᴀɴɢᴇ ᴠᴇʀɪғʏ ᴛɪᴍᴇ
• /time3 ᴛᴏ ᴄʜᴀɴɢᴇ ᴠᴇʀɪғʏ ᴛɪᴍᴇ
• /verifyoff for verify off [owner only]
• /verifyon - on verification [owner only]
...
• /most to get most search buttons
...
• /tgm - to get telegraph image link
• /stream - to get fast download and stream link
...
ʙʏ /ginfo ᴄᴏᴍᴍᴀɴᴅ</b>"""
    ...
    FSUB_TXT = """<b>
<b>• ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀɴ ᴀᴅᴍɪɴ 
...
›› ꜱᴛᴇᴘ 2 : ᴜꜱᴇ /settings ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ ᴄʜᴀɴɢᴇ ʙᴏᴛ sʜᴏʀᴛʟɪɴᴋ sᴇᴛᴛɪɴɢ.
...
›› ꜱᴛᴇᴘ 4 : ɪꜰ ʏᴏᴜ ᴅᴏɴ'ᴛ ᴜꜱɪɴɢ ᴀɴʏ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴛʜᴇɴ ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ꜰɪʀꜱᴛ ᴏɴ <a href='https://inshorturl.com/ref/Subaru061'>inshorturl.com</a> (ʏᴏᴜ ᴄᴀɴ ᴀʟꜱᴏ ᴜꜱᴇ ᴏᴛʜᴇʀ ʟɪɴᴋ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ).

›› ꜱᴛᴇᴘ 5 : ᴄᴏᴘʏ ʏᴏᴜʀ ᴀᴘɪ ꜰʀᴏᴍ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴛʜᴇɴ, ꜱɪᴍᴘʟʏ ꜱᴇᴛ ʏᴏᴜʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ ᴜꜱɪɴɢ ᴛʜᴇ /shortlink ᴄᴏᴍᴍᴀɴᴅ.

› ʟɪᴋᴇ ᴛʜɪꜱ :</b>  <code>/shortlink inshorturl.com 1502a197c85d59929d50f1cba1d5e6f967d1e9</code>
...
› ʟɪᴋᴇ ᴛʜɪꜱ :</b> <code>/set_tutorial https://t.me/Bypass_Shortlink/2</code>

<b>›› ꜱᴛᴇᴘ 8 : ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴄʜᴇᴄᴋ ᴡʜɪᴄʜ sʜᴏʀᴛᴇɴᴇʀ ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜᴇɴ sᴇɴᴅ /ginfo ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
...
ᴛʜᴇsᴇ ᴀʀᴇ sᴏᴍᴇ ᴀɪ/ᴇxᴘᴇʀᴛ ᴄᴏᴍᴍᴀɴᴅs
 ...
 ➻ /wall : Input image name for search 
"""
